<div class="header container">
  <div class="jumbotron">
    <h5>
      <div id="call-codice" class="text-left" style="color:white"><br>
        <button class="btn btn-mini"><i class="icon-download-alt"></i> ${message('actions.attachments')}</button>
      </div>
    </h5>
    <h4><div id="application-title" style="color:white"></div></h4>
    <h4><div id="call-desc" style="color:white"></div></h4>
    <h5><div id="appl-rich" style="color:white"></div></h5>
    <h5><div id="call-desc-rid" style="color:white"></div></h5>
    <h5><p style="color:white">${message('application.text.dichiarazione.responsabilita')}</p></h5>
  </div>
</div>
